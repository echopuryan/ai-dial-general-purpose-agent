...
class FileContentExtractionTool(BaseTool):
    ...
    def description(self) -> str:
        return "Extracts text content from files. Supported: PDF (text only), TXT, CSV (as markdown table), HTML/HTM. For large documents pagination is enabled. Each page consists of 10000 characters."
